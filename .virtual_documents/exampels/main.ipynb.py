...
generate_pressure_map(n_pic, n_fibers, x= 97, y = 97, part='generated_gauses/fresh_gauss'+str(n_gauses)+'_'+str(n_pic)+'.npy')


input, output, input_test, output_test = sim_on_gpu('generated_gauses/fresh_gauss'+str(n_gauses)+'_'+str(n_pic)+'.npy', n_random_rot=n_rot, n_angles=n_fibers, batch_size_preproc=128*8)
...
model = SensorNN4S(input_shape[1:3], output_shape[1:3])
