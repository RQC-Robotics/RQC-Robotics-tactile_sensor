...
## Video_dataset
При создании нужно указать путь к папке с видео и с сигналами соответствующими. Однократно загружает все видео для определения и запоминания их длин.
